...
export const PERALBA_ITEMS: QuoteItem[] = [
    ...
    { description: "MSHMEHPIBG0735Y MITSUBISHI - REFREDADORA BOMBA DE CALOR MEHP-iB-G07 35Y", quantity: 1, unitPrice: 20548, discount: 40 },
    ...
    { description: "AQUAFLEX - COLECTOR COL120/4-125", quantity: 1, unitPrice: 609, discount: 35 },
    { description: "AQUAFLEX - ANCLATGE PARET COLECTOR", quantity: 1, unitPrice: 78, discount: 35 },
    { description: "AQU20355RP8 AQUAFLEX - 20355R-P8 GRUP HIDRAULIC IMPULSIO DIRECTE DN25", quantity: 4, unitPrice: 442, discount: 35 },
    ...
    { description: "ALB18735 ALB - TR M2 PANELL LLIS ALUMINI ACUTEC H-25MM RT-0,80 ACÚSTIC (C-12M2)", quantity: 350, unitPrice: 25.20, discount: 48 },
    ...
    { description: "ALB18690 ALB - TR MTS. ROTLLE CINTA PERIMETRAL 150X8 MM. (R-50MTS)", quantity: 350, unitPrice: 3.26, discount: 45 },
    ...
    { description: "ALBPD1020816 ALB - COL·LECTOR PREMUNTAT ULTRACOMPACTE \"2+3\" 8 SORT. A/CABALIMETRE A/CAIXA (TUB 16X2)", quantity: 1, unitPrice: 649.56, discount: 50 },
    { description: "ALBPD1021016 ALB - COL.LECTOR ALB ULTRACOMPACTE 2+3 EN CAIXA ALB 10 VIES BICONOS 16", quantity: 2, unitPrice: 772.07, discount: 50 },
    ...
    { description: "ALB01561 ALB - CAPÇAL ELÈCTRIC 230V NC SENSE MICRO 2FILS", quantity: 39, unitPrice: 38.08, discount: 45 },
